      ...
      <nav>
        <div class = "ul-warp">
            <ul class="nav nav-justified">
                ...
                <li><router-link class="btn btn-m"  to="/video">视频</router-link></li>
                <li><router-link class="btn btn-m"  to="/joke">段子</router-link></li>
                <li class="active"><router-link class="btn btn-m"  to="/stream">直播</router-link></li>
                <li><router-link class="btn btn-m"  to="/show">段友秀</router-link></li>
            </ul>
          </div>
      </nav>
  </div>
